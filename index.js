...
*/
//Need to change the function to arrow syntax => Complete
// Deconstruct the object within the for of loop => Complete
//remove the original variables => Complete
...
/*
  ...
  You should not need to make any other changes to the code.
*/
// change function to arrow syntax => Complete
// destructure array use let instead of const so array is mutable => Complete
// rest operator used within the array  => Complete
...
/*
  ...
  You should not need to make any other changes to the code.
*/
//Change from function to arrow syntax =>
//Defaulting the param set it equal to the outcome you want => Complete
//Create object shorthand => Complete
